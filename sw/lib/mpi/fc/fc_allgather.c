...
void mpi_fc_Allgather_send_row(void* recvbuf, int sendcount, MPI_Datatype sendtype, MPI_Comm comm)
{
...
void mpi_fc_Allgather_send_col(void* recvbuf, int sendcount, MPI_Datatype sendtype, MPI_Comm comm)
{
...
)
{
    ...
    mpi_fc_Allgather_send_row(recvbuf, sendcount, sendtype, comm);
    mpi_fc_Allgather_send_col(recvbuf, sendcount, sendtype, comm);
    return MPI_SUCCESS;
}
